...
namespace trucki.Migrations
{
    ...
    [Migration("20240306104434_addPhonenumberToString")]
    partial class addPhonenumberToString
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("trucki.Entities.Company", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("trucki.Entities.Driver", b =>
                {
                    b.HasOne("trucki.Entities.Company", null)
                        .WithMany("Drivers")
            ...
            modelBuilder.Entity("trucki.Entities.Manager", b =>
                {
                    b.HasOne("trucki.Entities.Company", "Company")
                        .WithMany("Managers")
                        .HasForeignKey("CompanyId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
