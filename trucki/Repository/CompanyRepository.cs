...
namespace trucki.Repository
{
    public class CompanyRepository : RepositoryBase<Company>, ICompanyRepository
    {
        ...
        public async Task<Company> FetchComapnyById(string managerId, bool trackChanges) => await FindByCondition(x => x.Id.ToLower().Equals(managerId.ToLower()), trackChanges).FirstOrDefaultAsync();
